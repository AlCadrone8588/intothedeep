    ...
    public class blueCloseAuto extends LinearOpMode {
        ...
        public void runOpMode() {
            ...
            if (opModeIsActive()) {
                ...
                runMotors(200,getDistance(1,1,1,1,15.5));
                sleep(1000);
                if(leftColor.blue() > 60){
                    ...
                    runMotors(200,getDistance(1,1,-1,-1,14));
                    sleep(500);
                    runMotors(200,getDistance(1,1,1,1,3));
                    sleep(500);
                    runMotors(200,getDistance(-1,-1,-1,-1,20));
                    sleep(500);
                    runMotors(150,getDistance(1,1,-1,-1,26));
                    sleep(500);
